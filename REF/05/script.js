...
function initializeMegaMenu() {
  ...
  navLinks.forEach((link) => {
    link.addEventListener("click", (e) => {
      ...
      // Don't open mega menu on mobile when hamburger menu is visible
  ...
  // Close mega menu handlers
  closeMegaMenu.addEventListener("click", closeMegaMenuHandler)
  ...
  navbar.addEventListener("mouseleave", () => {
    navbarLeaveTimeout = setTimeout(() => {
      if (!megaMenuOverlay.matches(":hover")) {
        closeMegaMenuHandler()
      }
    }, 200)
  })
  ...
  megaMenuOverlay.addEventListener("mouseleave", () => {
    setTimeout(() => {
      closeMegaMenuHandler()
    }, 100)
  })
...
document.querySelectorAll(".menu-link").forEach((link) => {
  link.addEventListener("click", (e) => {
    ...
    // Close mega menu after selection
    setTimeout(() => {
      closeMegaMenuHandler()
    }, 300)

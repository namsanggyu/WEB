...
document.addEventListener("DOMContentLoaded", () => {
  ...
  initializeParticles()
  // initializeMegaMenu() // Removed mega menu initialization
})

// Mega Menu Functionality
// 삭제: initializeMegaMenu, openMegaMenu, closeMegaMenuHandler 등 메가 메뉴 관련 함수 및 이벤트
...
document.querySelectorAll(".menu-link").forEach((link) => {
  link.addEventListener("click", (e) => {
    ...
    // setTimeout(() => { // This line is no longer needed as mega menu is removed
...
const debouncedResize = debounce(() => {
  ...
  // This function is no longer needed as mega menu is removed
}, 250)
